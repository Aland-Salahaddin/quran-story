  ...
  return (
    <div className="relative min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      >
        <Link
          href="/"
          className="inline-flex items-center gap-3 text-xl font-bold px-6 py-3 rounded-full transition-all duration-200 group hover:bg-[rgba(212,168,83,0.1)] border-2 border-transparent hover:border-[rgba(212,168,83,0.8)]"
